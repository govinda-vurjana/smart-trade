...
from inference import TradingInference




# Function to be called when 20 minutes of data is ready for prediction
def data_ready_for_prediction(min,dataReader,file,trader):
...
while True:
    ...
    if data_duration >=3:
        ...
        data_ready_for_prediction(3,dataReader,oneminfile,trader)  # Call the function when 10 minutes of data is available
